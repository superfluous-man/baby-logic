...
**_In recent years_** even in the field of anthropology, which was once the field most committed to the truth of relativism, there has been a growing emphasis on the universal values underlying culturally different ways of expressing those values. To take a few examples, we all:
...
- **_But then_**, wait a moment, doesn't relativism just reappear on another level?
...
<div class="pull-right"> -- Marlene Goodbrod</div>
...
- Follow this direct link: [A Starting Point](https://www.astartingpoint.com/){target="_blank"}, or view in window below.


  <div class="embed">
  <iframe src="https://www.astartingpoint.com/"></iframe>
  </div>
...
<div>
[new tab](https://gwmatthews.github.io/ethics-slideshows/04-phl210-slides.html){target="_blank"}
</div>
</div>
...
<iframe src="https://www.youtube.com/embed/FOoffXFpAlU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
...
Hank Green explores the question of whether or not our values are just a matter of opinion in this [Crash Course Philosophy](https://www.youtube.com/playlist?list=PL8dPuuaLjXtNgK6MZucdYldNkMybYIHKR) video.
